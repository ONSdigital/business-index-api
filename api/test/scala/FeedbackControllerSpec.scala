...
//      val testObj = FeedbackObj(None, "doej", "John Doe", "01/01/2000", "Data Issue", Some(List(898989898989L, 111189898989L)), Some("BusinessName:test&limit1000"), "UBRN does not match given company name.", None)
