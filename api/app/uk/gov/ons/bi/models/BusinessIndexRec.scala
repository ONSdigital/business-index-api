...
case class BusinessIndexRec(
     ...
     @ApiModelProperty(value = "The business's Company Number to be identified by Companies House", dataType = "String", example = "29531562", required = false) companyNo: Option[String]
                           ) {
