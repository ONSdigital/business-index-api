...
// *
// */
//class ElasticSearchDao @Inject()(elastic: HttpClient, config: Config)(implicit context: ExecutionContext) extends ElasticDsl with StrictLogging with SearchControllerUtils {
//
